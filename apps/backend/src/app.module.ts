...
@Module({
  imports: [PrismaModule, CategoryModule, ProductModule, AuthModule, UserModule, AddressModule, ProductImageModule, SupernaturalEffectModule, ProductEffectModule, OrderModule, ReviewModule, OrderItemModule],
